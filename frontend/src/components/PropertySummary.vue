<template>
    <div class="property-container" v-if="min_total_monthly_cost">
        <img class="property__image" src="../assets/unsplash-kitchen-design_1280x720.jpg" alt="unsplash kitchen design" />
        <img class="property__image" src="../assets/unsplash-bedroom-2_1280x720.jpg" alt="unsplash bedroom design" />        
        <div class="property__details-box">
            <router-link :to="{name: 'PropertyDetails', params: {property_id: property.property_id}}"> 

                ...
                >
                    <div class="select-property__card">
                        ...
                        <div class=select-property__num-bedrooms-num-bathrooms>
                            <span class="select-property__fa-icon"><font-awesome-icon class="page-heading__fa-icon fa-sm" icon="bed" /></span>
                            <span class="select-property__num-bedrooms">{{ get_num_bedrooms(property) }}</span>
                            <span class="select-property__fa-icon"><font-awesome-icon class="page-heading__fa-icon fa-sm" icon="bath" /></span>
